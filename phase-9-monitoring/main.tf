...
provider "azurerm" {
  ...
  subscription_id = "d2a326a3-9372-4135-bdf9-3d5845e89389"
}
...
resource "azurerm_kubernetes_cluster" "main" {
  ...
  azure_active_directory_role_based_access_control {
    admin_group_object_ids = ["756a89c2-520f-4c7a-b984-d597a9fec3cb"]
  }
...
resource "azurerm_kubernetes_flux_configuration" "main" {
  ...
  kustomizations {
    ...
    path                       = "./phase-9-monitoring/gitops/infrastructure/controllers/staging"
  ...
  kustomizations {
    name                       = "infra-configs"
    path                       = "./phase-9-monitoring/gitops/infrastructure/configs/staging"
    sync_interval_in_seconds   = 300
  ...
  kustomizations {
    ...
    path                       = "./phase-9-monitoring/gitops/monitoring/controllers/staging"
    sync_interval_in_seconds   = 300
    depends_on                 = ["infra-controllers"]
    garbage_collection_enabled = true
  }
  ...
  kustomizations {
    ...
    path                       = "./phase-9-monitoring/gitops/monitoring/configs/staging"
    sync_interval_in_seconds   = 300
  ...
  kustomizations {
    name                       = "apps"
    path                       = "./phase-9-monitoring/gitops/apps/staging"
    sync_interval_in_seconds   = 300
